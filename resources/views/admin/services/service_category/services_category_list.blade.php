						...
						<div class="m-portlet__head">
							<div class="m-portlet__head-tools">	
								<div class="headingpage">
									...
									<a href="{{route('services_category_operation',['type' => 'add'])}}" class="btn btn-accent m-btn m-btn--air m-btn--custom purplebtn createbtn btn-margin">
									...
									<table class="table table-bordered table-hover" id="html_table">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a href="{{url(route('services_category_operation',['type' => 'edit','id' => $row->services_category_id]))}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill editbtn" title="Edit Data"><i class="fa fa-edit"></i></a>
												</td>
											</tr>
											@endforeach
										</tbody>
