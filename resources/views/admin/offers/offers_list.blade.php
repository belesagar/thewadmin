						...
						<div class="m-portlet__head">
							<div class="m-portlet__head-tools">	
								<div class="headingpage">
									...
									Offer List
									<a href="{{route('add_offer')}}" class="btn btn-accent m-btn m-btn--air m-btn--custom purplebtn createbtn btn-margin">
										Add Offer
									</a>
								</div>											
							</div>										
									...
									<table class="table table-bordered table-hover" id="html_table">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a href="{{url(route('edit_offer',['id' => $row->offer_id]))}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill editbtn" title="Edit Data"><i class="fa fa-edit"></i></a>
												</td>
											</tr>
											@endforeach
										</tbody>
