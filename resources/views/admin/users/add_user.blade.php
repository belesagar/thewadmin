								...
								<div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="m_user_profile_tab_1">
											{{ Form::open(array('class' => 'm-form m-form--fit m-form--label-align-right','id' => 'id_add_user','route' => 'add_user_data')) }}
													...
													<div class="m-form__actions">
														<div class="row">
															...
															<div class="col-7">
																...
																&nbsp;&nbsp;
																<a href="{{route('userslist')}}" class="btn btn-secondary m-btn m-btn--air m-btn--custom">
																	Cancel
																</a>
															</div>
														</div>
